...
public class JsonSerializableTest {
    ...
    public void testMetaDataEpisodeSerializable() {
        ...
        MetaData.Episode original = new MetaData.Episode("media123", "Test Title", "Test summary", LocalDate.now(), 6.5f);
        String json = assertDoesNotThrow(() -> original.toJson().toString());

        MetaData.Episode deserialized = assertDoesNotThrow(() -> JsonSerializable.fromJson(json, MetaData.Episode.class));
        assertEquals(original, deserialized, "Deserialized object does not match the original");
    }
    ...
    public void testMetaDataSeriesSerializable() {
        ...
        MetaData.Series original = new MetaData.Series("series123", "Series Title", "Series summary", LocalDate.now(), 7.8f);
        String json = assertDoesNotThrow(() -> original.toJson().toString());
    ...
    public void testDataMineRequestMovieSerializable() {
        ...
        DataMineRequest.Movie deserialized = assertDoesNotThrow(() -> JsonSerializable.fromJson(json, DataMineRequest.Movie.class));
        assertEquals(original, deserialized, "Deserialized object does not match the original");
    }
    ...
    public void testDataMineRequestSeriesSerializable() {
        ...
        DataMineRequest.Series original = new DataMineRequest.Series("series123", "Series Title");
        String json = assertDoesNotThrow(() -> original.toJson().toString());

        DataMineRequest.Series deserialized = assertDoesNotThrow(() -> JsonSerializable.fromJson(json, DataMineRequest.Series.class));
        assertEquals(original, deserialized, "Deserialized object does not match the original");
    }
    ...
    public void testDataMineRequestEpisodeSerializable() {
        ...
        DataMineRequest.Episode original = new DataMineRequest.Episode("media123", "episode123", "Episode Title", 4, "Series Title", 2);
        String json = assertDoesNotThrow(() -> original.toJson().toString());

        DataMineRequest.Episode deserialized = assertDoesNotThrow(() -> JsonSerializable.fromJson(json, DataMineRequest.Episode.class));
        assertEquals(original, deserialized, "Deserialized object does not match the original");
    }
